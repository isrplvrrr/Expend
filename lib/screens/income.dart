...
import 'package:expend/screens/income_screen.dart';
...
class _IncomeState extends State<Income> {
  ...
  void createGroup() {
    ...
    if (text.isNotEmpty) {
      final task = Incom(name: text, adds: []);
      groupBox.add(task);
      controller.clear();
      setState(() {});
    } else {
  ...
  void openTask(int index) {
    Navigator.of(context)
        .push(
          PageRouteBuilder(
            pageBuilder: (_, __, ___) => IncomeScreen(incomeIndex: index),
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                  '${groupBox.getAt(i)!.name}',
                                                  textAlign: TextAlign.center,
                                                ),
                                                Text(
                                                  '${groupBox.getAt(i)!.tatal ?? 0.0}',
                                                ),
                                              ],
                                            ),
                                          ),
